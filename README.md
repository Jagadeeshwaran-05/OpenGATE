...
- **AI Mock Test Simulator**: An interactive examination engine accessible in the fullscreen tutor panel. It generates a custom 20-question mock test (10 reference PYQ/study material questions pulled via ChromaDB RAG, and 10 generated by AI matching active syllabus subjects) and provides a scorecard with a detailed question-by-question grading review and explanations.
...
│   │   ├── test_manager.py # Mock test generator, RAG extractor, and batch evaluator
