...
def parse_readme_resources(readme_path: str) -> List[Dict]:
    """Parse list of resource links from subject README guides in the dsai-gate repository."""
...
def get_curriculum_data_da() -> List[Dict]:
    """Parse main guide table in dsai-gate README.md to generate syllabus topic nodes."""
...
def parse_cse_readme_resources(readme_path: str) -> Dict[str, List[Dict]]:
    """Parse compiled resources by subject header from cse-gate README.md."""
    if not os.path.exists(readme_path):
        return {}
...
def get_curriculum_data_cs() -> List[Dict]:
    """Load dynamic resource links from cse-gate repository README.md and construct CS syllabus objects."""
